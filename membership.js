// Membership page JavaScript functionality
...
function loadNavbar() {
  fetch('navbar.html')
    ...
    .catch(error => {
      ...
      document.getElementById('navbar-container').appendChild(errorElement);
    });
}
...
function loadFooter() {
  fetch('footer.html')
    ...
    .catch(error => {
      ...
      document.getElementById('footer-container').appendChild(errorElement);
    });
}
